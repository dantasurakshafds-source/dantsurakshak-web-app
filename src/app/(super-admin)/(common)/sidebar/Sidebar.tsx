...
const links = [
  ...
  {
    href: "/super-admin/dental-experts",
  ...
  {
    href: "/super-admin/oral-diseases",
    label: "Oral Diseases",
    icon: HeartPulse,
  },

  {
    href: "/super-admin/oral-health-habits",
    label: "Oral Health Habits",
    icon: ClipboardList,
  },

  {
    href: "/super-admin/dental-emergencies",
    label: "Dental Emergencies",
    icon: ShieldAlert,
  },

  {
    href: "/super-admin/health-assessments",
    label: "Health Assessments",
    icon: ClipboardList,
  },

  {
    href: "/super-admin/myths-facts",
    label: "Dental Myths & Facts",
    icon: BookOpenCheck,
  },
  ...
  {
    href: "/super-admin/privacy-policy",
    label: "Privacy Policy",
    icon: ShieldEllipsis,
  },

  {
    href: "/super-admin/terms-conditions",
